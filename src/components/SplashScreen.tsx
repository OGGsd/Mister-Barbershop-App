...
const SplashScreen: React.FC = () => {
  return (
    <motion.div 
      className="fixed inset-0 bg-[#F4A300] flex items-center justify-center z-50 overflow-hidden"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
        ...
        >
          ...
          >
            <motion.img 
              ...
              className="w-20 h-20 md:w-24 md:h-24 mr-4 rounded-full bg-white p-2 shadow-lg"
              animate={{
                boxShadow: [
